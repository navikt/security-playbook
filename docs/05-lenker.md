...
| [#security-champion-playbook-aktivitet](https://nav-it.slack.com/archives/C0314EZ719S) | Meldinger fra GitHub om aktivitet i [security-champions](https://github.com/navikt/security-champions)-repoet |
...
- [Oversikt over security champions](https://teamkatalog.nais.adeo.no/dashboard/members/role/SECURITY_CHAMPION)
